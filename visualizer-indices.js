// visualizer.js
// Reads ScoresCurrent from data/stocks.xlsx and generates data/indices.html
// Usage:
//   node visualizer.js           → writes data/report.html
//   node visualizer-indices.js --serve   → writes + opens in browser via local server
...
const OUTPUT_PATH = path.resolve(__dirname, "data/indices.html");
