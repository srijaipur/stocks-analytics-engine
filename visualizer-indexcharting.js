...
const OUTPUT_PATH = path.resolve(__dirname, "data/indexcharting.html");
...
// ======================================================
//
// These benchmark families will eventually be populated
// from Firestore configuration.
//
// Phase 4.2 only establishes the canonical structure.
// No Firestore reads occur yet.
//
...
(async () => {
  ...
  console.log("indexcharting.html generated");
  ...
  if (SERVE) {
    http
      .createServer((req, res) => {
        ...
        if (req.url === "/api/indexcharting-data.js") {
          const payload = `
window.__INDEXCHARTING__ = ${JSON.stringify(data)};
`;
