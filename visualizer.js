...
function renderLoginScreen() {
  ...
  authEl.innerHTML =
    ...
    '<button id="loginBtn" style="background:#2563eb;color:white;border:none;border-radius:8px;padding:12px 18px;cursor:pointer;font-size:16px;">' +
    'Sign in with Google' +
    '</button>' +
    '</div>';
